...
let tarotImages = [
  ...
  {index:9, src: "assets/img/FiveCupsRWS.jpg", alt: "Five of Cups from the Rider-Waite-Smith tarot deck", modalId:"Cups05RWS", modalContent: "Suit  : Cups </p> <p> Value  : Five (5) </p> <p> Plot : alienation, sadness, poor harvest </p> <p> Character : misanthrope, traumatized, low self-care</p> <p> Energy/setting : water </p> "},
...
// set modal id to default relative card image
    ...
    if (buttonTrigger) {
      ...
      // Check if a modal is open by checking if the body has the class 'is-open'
      let body = document.querySelector('body');
      if (body.classList.contains('is-open')) {
        // If a modal is open, set aria-hidden to false
        body.setAttribute('aria-hidden', "false");
      } else {
        console.log("modal is closed aria hidden true");
      }
